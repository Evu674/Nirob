...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://facebook.com/rasel674/')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '1':
        i()
    if opt == '2':
        os.system('xdg-open https://www.facebook.com/nibirahmed674')
        return None
    if opt == '3':
...
def rcrack(uid,pwx,tl):
    ...
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="113.0.5660.201", "Google Chrome";v="113.0.5660.201"',
    'sec-ch-ua-mobile': '?0',
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.5660.201 Safari/537.36',
    'viewport-width': '980',}
